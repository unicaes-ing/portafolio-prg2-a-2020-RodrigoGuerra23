        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtNumero1.Text == "")
                {
                    ...
                    lblmayo.Text = Mayor(n2, n3).ToString();
                }
                else if (txtNumero2.Text == "")
                {
                    n1 = Convert.ToInt32(txtNumero1.Text);
                    n3 = Convert.ToInt32(txtNumero3.Text);
                    lblmayo.Text = Mayor(n1, n3).ToString();
                }
                else if (txtNumero3.Text == "")
                {
                    n1 = Convert.ToInt32(txtNumero1.Text);
                    n2 = Convert.ToInt32(txtNumero2.Text);
                    lblmayo.Text = Mayor(n1, n2).ToString();
                }
                else
                {
                    n1 = Convert.ToInt32(txtNumero1.Text);
                    n2 = Convert.ToInt32(txtNumero2.Text);
                    n3 = Convert.ToInt32(txtNumero3.Text);
                    lblmayo.Text = Mayor(n1, n2, n3).ToString();
                }
            }
            catch (Exception)
            {
